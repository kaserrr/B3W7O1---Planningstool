    ...
    <section class="m-3">
        <div class="row justify-content-md-center border border-secondary w-100 m-0 my-1">
            <div class="col-md-4 dark-bg p-3">
                <img class="image" src="resources/images/<?php echo $game['image'];?>" alt="<?php echo $game['image'];?>">
            </div> 
        ...
        <div class="row justify-content-md-center h-100 w-100 m-0 my-1">
            <div class="d-flex flex-column col-md-6 dark-bg text-white text-center border border-secondary">
                <h1>
                    <?php echo $game['name'];?>
                </h1>
                <p>
            ...
            <div class="d-flex flex-row col-md-6 dark-bg text-white text-center border border-secondary">
                <div class="w-50">
        ...
        <div class="d-flex w-100 justify-content-around dark-bg text-white text-center skills border border-secondary w-100 m-0 my-1">
            <div class="border-right border-secondary align-middle p-1">
